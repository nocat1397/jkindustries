<div class="header">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              <ul class="navbar-nav ml-auto text-center" style="flex-direction: row!important; justify-content: center">
                <li><a href="tel:08048722507" class="link-hover-style mr-2"><i class="fa fa-phone mr-1"></i> 08048722507</a></li>
    ...
    <section class="header-section">
        <div class="center-div">
          ...
          <h3 class="font-weight-bold text-capitalize m-0 text-warning">welcome to JK industries</h3>
          <p id="spin" class="text-light m-0" style="font-size: 15px"></p>
